	...
	On local Error Goto Intercept_Error
		...
		Scope
			...
			IF Mkdir("1.2.3") = -1 then
				...
				CPCDOS_INSTANCE.SHELLCCP_INSTANCE.CpcdosCP_SHELL("SET/ CPC_LFN = 0", CPCDOS_INSTANCE.SYSTEME_INSTANCE._MAIN_CLE, 5, 0, "")
			Else
				...
				CPCDOS_INSTANCE.SHELLCCP_INSTANCE.CpcdosCP_SHELL("SET/ CPC_LFN = 1", CPCDOS_INSTANCE.SYSTEME_INSTANCE._MAIN_CLE, 5, 0, "")
				RmDir "1.2.3"
			End if
